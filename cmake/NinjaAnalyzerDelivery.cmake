function(ninja_analyzer_configure_delivery target)
    ...
    add_custom_command(TARGET ${target} POST_BUILD
        COMMAND "${CMAKE_COMMAND}"
            "-DNINJA_ANALYZER_BUILD_BUNDLE=$<TARGET_BUNDLE_DIR:${target}>"
            -P "${CMAKE_CURRENT_BINARY_DIR}/NinjaAnalyzerDeployInstall.cmake"
        COMMAND "${CMAKE_COMMAND}"
            "-DAPP_BUNDLE=$<TARGET_BUNDLE_DIR:${target}>"
            "-DEXPECTED_BUNDLE=${CMAKE_BINARY_DIR}/bin/Ninja Log Analyzer.app"
            "-DLEGACY_BUNDLE=${CMAKE_BINARY_DIR}/Ninja Log Analyzer.app"
            -P "${PROJECT_SOURCE_DIR}/cmake/NinjaAnalyzerVerifyMacBundle.cmake"
        COMMENT "Deploying self-contained macOS app bundle"
        VERBATIM
    )
